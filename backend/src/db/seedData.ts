...
export const DEFAULT_SERVICES = [
  {
    ...
    title: 'Bridal Mehndi',
    description:
      'Premium, ultra-intricate custom-designed masterpieces running from fingertips up to the elbows on both sides. Captures beautiful royal story elements and motifs with longlasting dark henna stain.',
    imageUrl: '/bride.jpeg',
    startingPrice: '10000',
  },
  {
    ...
    title: 'Custom Mehndi',
    description:
      'Intricately detailed customized hand-drawn sketches of the bride and groom, divine figures like Radha-Krishna, baby shower sketches, or custom portraits merged in traditional bridal lore.',
    imageUrl: '/custom design.jpeg',
    startingPrice: '6000',
  },
  {
    id: 'service-3',
    title: 'Arabic Mehndi',
    description:
      'Modern, flowing, and bold floral diagonal clusters with exquisite shaded negative spaces. This minimalist and sleek choice is ideal for bridesmaids, siblings, and guest packages.',
    imageUrl: '/arabic.jpeg',
    startingPrice: '1500',
  },
  {
    id: 'service-4',
    ...
    description:
      'A gorgeous fusion celebrating bold, broad Arabic floral outlines combined with ultra-dense, detailed micro-fillers characteristic of classic Rajasthani and Indian patterns.',
    imageUrl: '/indo arabic.jpeg',
    startingPrice: '2500',
  },
  {
    id: 'service-5',
    ...
    description:
      'Neat, delightful semi-bridal layouts optimized for engagement rings and photoshoot aesthetics, highlighting beautiful mandala centerpieces and custom wrist cuffs.',
    imageUrl: '/engagement.jpeg',
    startingPrice: '3100',
  },
  {
    id: 'service-6',
    ...
    description:
      'Quick, auspicious, and beautiful traditional henna patterns applied during special Indian cultural festivals like Karwa Chauth, Teej, Eid, Diwali, and Hariyali Teej.',
    imageUrl: '/festival design.jpeg',
    startingPrice: '500',
  },
] as const;
...
export const DEFAULT_GALLERY = [
  {
    id: 'gallery-1',
    imageUrl: '/Royal Indian Bridal Mehndi.jpeg',
    category: 'bridal',
  ...
  {
    id: 'gallery-3',
    imageUrl: '/Bride & Groom Portrait Hand.jpg',
    category: 'portrait',
  ...
  {
    id: 'gallery-4',
    imageUrl: '/Radha Krishna Custom Portrait.webp',
    category: 'portrait',
  ...
  {
    id: 'gallery-5',
    imageUrl: '/Elegant Bold Arabic vine.jpeg',
    category: 'arabic',
  ...
  {
    id: 'gallery-6',
    imageUrl: '/Modern Indo-Arabic Fusion.webp',
  ...
  {
    id: 'gallery-7',
    imageUrl: '/Karwa Chauth Diya Scene.jpeg',
    category: 'festival',
  ...
  {
    id: 'gallery-8',
    imageUrl: '/Bespoke Henna Artist Craft.webp',
    category: 'customized',
